...
interface TrialParentDetailProps {
    onBack: () => void;
    onReschedule: () => void; // 👈 Menambahkan tipe data props disini
}

export function TrialParentDetail({ onBack, onReschedule }: TrialParentDetailProps) {
    return (
            ...
            <div className="row g-4">
                <div className="col-lg-8">
                    <div className="card border-0 rounded-4 shadow-sm p-4 p-md-5 mb-4 bg-white position-relative overflow-hidden" style={{ background: "linear-gradient(180deg, #FFFFFF 0%, #F8FAFC 100%)" }}>
                        <h2 className="fw-bold text-dark mb-2" style={{ fontSize: "1.75rem" }}>Konfirmasi Jadwal Observasi</h2>
                        ...
                        <div className="row g-4 mt-2">
                            <div className="col-sm-6 col-md-4">
                                ...
                                <h5 className="fw-bold text-dark mb-0">Arkananta Rayyan</h5>
                            </div>
                            <div className="col-sm-6 col-md-4">
                    ...
                    <div className="card border-0 border-start border-4 border-success rounded-4 shadow-sm p-4 bg-white" style={{ backgroundColor: "#F0FDF4" }}>
                        <div className="d-flex gap-3 align-items-start">
                            ...
                            <div>
                                ...
                                <p className="text-muted mb-0" style={{ fontStyle: "italic", lineHeight: "1.5" }}>
                                    "Halo Bapak/Ibu, kami sangat menantikan kehadiran Arkananta. Mohon pastikan ananda sudah sarapan dan membawa botol minum sendiri. Orang tua diharapkan mendampingi di 15 menit pertama sesi observasi."
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="col-lg-4">
                    ...
                    <div className="d-flex flex-column gap-2 mb-4">
                        <button className="btn w-100 py-3 rounded-3 d-flex align-items-center justify-content-center gap-2 fw-bold shadow-sm" style={{ backgroundColor: "#06245C", color: "#FFFFFF", border: "none" }}>
                            <IconCircleCheck size={20} /> Setuju & Konfirmasi Jadwal
                        </button>
