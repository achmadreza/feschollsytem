    ...
    return (
        <div className="container-xl" style={{ backgroundColor: "#F8FAFC", minHeight: "100vh", paddingBottom: "2rem" }}>
            ...
            <div className="row row-cols-1 row-cols-sm-2 row-cols-lg-4 g-3 mb-4">
                <div className="col">
                    <div 
                        className="card border-0 shadow-sm position-relative overflow-hidden h-100" 
                        style={{ borderRadius: "16px", minHeight: "170px" }}
                    >
                        <div 
                            className="position-absolute top-0 bottom-0 start-0" 
                            style={{ width: "6px", backgroundColor: "#F59E0B" }} 
                        />
                        <div className="card-body p-4 d-flex flex-column justify-content-between position-relative z-1">
                            <div>
                                <span className="fw-bold text-uppercase" style={{ fontSize: "11px", color: "#F59E0B", letterSpacing: "0.05em" }}>
                                    MENUNGGU VERIFIKASI
                                </span>
                        ...
                        <div 
                            className="position-absolute text-secondary opacity-10 pointer-events-none" 
                            style={{ right: "-10px", bottom: "-15px", color: "#E2E8F0" }}
                        >
                ...
                <div className="col">
                    ...
                    >
                        <div 
                            className="position-absolute top-0 bottom-0 start-0" 
                            style={{ width: "6px", backgroundColor: "#10B981" }} 
                        />
                        <div className="card-body p-4 d-flex flex-column justify-content-between position-relative z-1">
                            <div>
                                <span className="fw-bold text-uppercase" style={{ fontSize: "11px", color: "#10B981", letterSpacing: "0.05em" }}>
                                    LUNAS HARI INI
                                </span>
                                ...
                                <div className="fw-bold text-dark mt-1" style={{ fontSize: "20px" }}>
                                    Rp 42.500.000
                                </div>
                            </div>
                        </div>
                ...
                <div className="col">
                    ...
                    >
                        <div 
                            className="position-absolute top-0 bottom-0 start-0" 
                            style={{ width: "6px", backgroundColor: "#DC2626" }} 
                        />
                        <div className="card-body p-4 d-flex flex-column justify-content-between position-relative z-1">
                            <div>
                                <span className="fw-bold text-uppercase" style={{ fontSize: "11px", color: "#DC2626", letterSpacing: "0.05em" }}>
                                    BELUM DIBAYAR
                                </span>
                                <div className="d-flex align-items-baseline gap-2 mt-2">
                ...
                <div className="col">
                    <div 
                        className="card border-0 shadow-sm position-relative overflow-hidden h-100 text-white" 
                        style={{ backgroundColor: "#0A194F", borderRadius: "16px", minHeight: "170px" }}
                    >
                        <div className="card-body p-4 d-flex flex-column justify-content-between position-relative z-1">
                            <div>
                                <span className="fw-bold text-uppercase" style={{ fontSize: "11px", color: "#94A3B8", letterSpacing: "0.05em" }}>
                                    TOTAL PEMASUKAN
                                </span>
                                <div className="mt-2">
                                    <div className="fw-semibold" style={{ fontSize: "20px", lineHeight: "1.2" }}>Rp</div>
                                    <div className="fw-bold" style={{ fontSize: "26px", letterSpacing: "-0.02em" }}>
                                        128.250.000
                                    </div>
                                </div>
                            </div>
                        ...
                        <div 
                            ...
                            style={{ right: "-10px", bottom: "-15px", color: "rgba(255, 255, 255, 0.08)" }}
                        >
                        ...
                        <table className="table table-borderless align-middle mb-0">
                            <thead>
                                <tr className="border-bottom" style={{ borderColor: "#F1F5F9" }}>
                                    ...
                                    <th className="py-3" style={{ width: "40px" }}></th>
                                </tr>
                            </thead>
                            <tbody>
                                {INITIAL_TRANSACTIONS.map((tx, idx) => (
                                    <tr key={idx} className="border-bottom" style={{ borderColor: "#F8FAFC" }}>
                                        <td className="py-3">
                                        ...
                                        <td className="py-3">
                                            <div>
                                                ...
                                                {tx.subtitle && (
                                                    <div className="text-secondary fw-semibold" style={{ fontSize: "10px", letterSpacing: "0.02em" }}>
                                                        {tx.subtitle}
                                                    </div>
                                                )}
                                            </div>
